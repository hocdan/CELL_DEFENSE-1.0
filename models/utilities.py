...
def draw_tilemapItens(pyxel, tilemap, sprite_bank, ALTURA, LARGURA, TAMANHO, ESCALA, DELTAX=0, DELTAY=0):
        ...
        for y in range(ALTURA):
            for x in range(LARGURA):
                ...
                pyxel.blt( 
                DELTAX + x * TAMANHO * ESCALA, #posicao X onde sera desenhado o item (pode-se fzer um ajuste manual com delta1)
                DELTAY + y * TAMANHO * ESCALA, #posicao Y onde sera desenhado o item (pode-se fzer um ajuste manual com delta2)
